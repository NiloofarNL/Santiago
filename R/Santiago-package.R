...
NULL
#' Santiago: A package based on a paper-based survey conducted face-to-face in Santiago in 2016.
#'
#' The goal of Santiago is to contribute to psychological impacts on travelers by examining the feelings of stress by users of active and motorized modes of transportation.Furthermore, it also investigates the importance that travelers attach to their feelings of stress.
#'
#'
#' @docType package
...
#' A package based on a paper-based survey conducted face-to-face in Santiago in 2016.
#'
...
#'   \item{r0B_MACRO_ZONE}{Macro area of residence}
...
#' @source A face to face survey considering pre-census 2012(https://www12.statcan.gc.ca/census-recensement/2011/index-eng.cfm)
#' @examples
#'  data(Santiago2016)
