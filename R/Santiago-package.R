...
#' Santiago: A data package based on a paper-based survey conducted face-to-face in Santiago in 2016.
...
#'  Santiago_H
#'
#'  A dataset containing Health information of users of active and motorized modes of transportation in Santiago sourced from 2016 survey.
#'
...
#'   Santiago_RPD
#'
#'   #'  A dataset containing information about reason and planning decision of users of active and motorized modes of transportation in Santiago sourced from 2016 survey.
#'
#'  @format A data frame with 451 rows and 23 variables:
#' \describe{
...
#'   Santiago_NS
#'
#'  A dataset containing information about Nature and sustainability from the viewpoint of users of active and motorized modes of transportation in Santiago sourced from 2016 survey.
#'
...
#'   Santiago_IS
#'
#'  A dataset containing information about shifting different modes by users of active and motorized modes of transportation in Santiago sourced from 2016 survey.
#'
